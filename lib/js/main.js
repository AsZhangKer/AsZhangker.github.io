(function() {
  ...
  var searchData = [
    ...
    { title: '友联 - zker.top', url: 'https://zker.top', icon: 'fa-link' },
    { title: '友联 - noctiro.moe', url: 'https://noctiro.moe', icon: 'fa-link' },
    { title: '友联 - azsu.top', url: 'https://azsu.top', icon: 'fa-link' },
